                ...
                <Slider {...sliderSettings}>
                    {banners.map(banner => {
                        if (banner.action){
                            ...
                            return <CategoryLink to={banner.url} className="d-flex justify-content-center align-items-center slider-card" onClick={this.props[banner.actionName]}><img alt="" src={banner.src}/></CategoryLink>
                        } else {
                            return <CategoryLink to={banner.url} className="d-flex justify-content-center align-items-center slider-card"><img alt="" src={banner.src}/></CategoryLink>
                        }
                    })}
                </Slider>
            </div>
